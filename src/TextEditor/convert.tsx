...
/**
 * Создадим функцию конвертирования состояния редактора в HTML.
 * В ней мы опишем правила, по которым хотим конвертировать данные редактора в разметку
 */
...
/**
 * Функцию конвертирования HTML в состояния редактора
 */
